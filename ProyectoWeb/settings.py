...
SECRET_KEY = 'django-insecure-9@31jd*i8p_jy_&c6cng9^r2-6i7=ggc(5dsf-v09-_mkrg5(#'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'carrito.context_processor.importe_almacenado',
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD="lnfztbnldgggvzyi"
